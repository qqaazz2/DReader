...
import 'package:DReader/widgets/KeepActivePage.dart';
...
class SettingPageState extends ConsumerState<SettingPage>
      ...
      children: [
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: Theme.of(
                                        context,
                                      ).shadowColor.withOpacity(0.2), // 更淡的阴影
                                      offset: const Offset(4, 4),
                                      blurRadius: 12,
                                      spreadRadius: 4,
                                    ),
        ...
        Expanded(
          child: SizedBox(
            ...
            height: double.infinity,
            child: SettingChart(constraints: constraints),
          ),
        ),
      ],
    );
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      labelText: "二次确认密码",
                      hintText: "二次确认密码",
                      prefixIcon: Icon(Icons.check, size: 18),
                    ),
                        ...
                        onPressed: () async {
                          ...
                          if (status) {
                            BaseResult baseResult = await HttpApi.request(
                              method: "post",
                              params: {
                                "oldPassWord": md5Encrypt(
                                  oldPassWordController.text,
                                ),
                                "newPassWord": md5Encrypt(
  ...
  //   // if(kIsWeb){
  //   //   return Image.network(path,width: double.infinity,height: double.infinity,headers: map,errorBuilder:(context,object,stackTrace) => Image.asset("images/2.png"));
  //   // }else{
